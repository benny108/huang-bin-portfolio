...
export const copy = {
  zh: {
    ...
    sections: {
      ...
      contactTitle: "如果你正在寻找能把研究推进到结果的人",
      contactBody: "欢迎交流 LLM / Agent 实习、科研合作、技术项目与博士研究机会。",
      viewAll: "查看全部",
      readCase: "查看案例",
      readArticle: "阅读全文",
      contribution: "我的贡献",
  ...
  en: {
    ...
    sections: {
      ...
      contactKicker: "CONTACT",
      contactTitle: "Looking for someone who can move research toward results?",
      contactBody:
        "Let’s discuss LLM / Agent internships, research collaboration, technical projects, or future PhD opportunities.",
      viewAll: "View all",
      readCase: "View case",
